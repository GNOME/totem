...
static void
setup_browse (TotemLibrary *self)
{
	GtkAdjustment *adj;
...
static void
create_debug_window (TotemLibrary       *self,
		     GtkTreeModel     *model)
{
...
static void
setup_config (TotemLibrary *self)
{
...
GtkWidget *
totem_library_new (TotemObject *totem,
		 GtkWidget   *header)
{
...
static void
totem_library_finalize (GObject *object)
{
