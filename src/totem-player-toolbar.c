...
static void
update_toolbar_state (TotemPlayerToolbar *bar)
{
  if (bar->select_mode)
    {
...
{
  totem_player_toolbar_set_select_mode (bar, FALSE);
}
...
totem_player_toolbar_set_property (GObject         *object,
                                 ...
                                 GParamSpec      *pspec)
{
  TotemPlayerToolbar *bar = TOTEM_PLAYER_TOOLBAR (object);

  switch (prop_id)
    {
    case PROP_TITLE:
      totem_player_toolbar_set_title (bar, g_value_get_string (value));
      break;

    case PROP_SUBTITLE:
      totem_player_toolbar_set_subtitle (bar, g_value_get_string (value));
      break;

    case PROP_SEARCH_STRING:
      totem_player_toolbar_set_search_string (bar, g_value_get_string (value));
      break;

    case PROP_N_SELECTED:
      totem_player_toolbar_set_n_selected (bar, g_value_get_uint (value));
      break;

    case PROP_SEARCH_MODE:
      totem_player_toolbar_set_search_mode (bar, g_value_get_boolean (value));
      break;
    ...
    case PROP_SELECT_MODE:
      totem_player_toolbar_set_select_mode (bar, g_value_get_boolean (value));
      break;
    ...
    case PROP_CUSTOM_TITLE:
      totem_player_toolbar_set_custom_title (bar, g_value_get_object (value));
      break;

    case PROP_SELECT_MENU_MODEL:
      totem_player_toolbar_set_select_menu_model (bar, g_value_get_object (value));
      break;
                                 ...
                                 GParamSpec      *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_SEARCH_STRING:
      g_value_set_string (value, totem_player_toolbar_get_search_string (bar));
      break;

    case PROP_N_SELECTED:
      g_value_set_uint (value, totem_player_toolbar_get_n_selected (bar));
      break;

    case PROP_SEARCH_MODE:
      g_value_set_boolean (value, totem_player_toolbar_get_search_mode (bar));
      break;
    ...
    case PROP_SELECT_MENU_MODEL:
      g_value_set_object (value, totem_player_toolbar_get_select_menu_model (bar));
      break;
...
static void
totem_player_toolbar_finalize (GObject *object)
{
  TotemPlayerToolbar *bar = TOTEM_PLAYER_TOOLBAR (object);

  g_free (bar->search_string);

  G_OBJECT_CLASS (totem_player_toolbar_parent_class)->finalize (object);
}
...
totem_player_toolbar_class_init (TotemPlayerToolbarClass *klass)
{
  ...
  object_class->finalize = totem_player_toolbar_finalize;
  ...
  gtk_widget_class_bind_template_child (widget_class, TotemPlayerToolbar, search_button);
  gtk_widget_class_bind_template_child (widget_class, TotemPlayerToolbar, select_button);
  gtk_widget_class_bind_template_child (widget_class, TotemPlayerToolbar, selection_menu_button);
  gtk_widget_class_bind_template_child (widget_class, TotemPlayerToolbar, done_button);
  gtk_widget_class_bind_template_child (widget_class, TotemPlayerToolbar, back_button);
  gtk_widget_class_bind_template_child (widget_class, TotemPlayerToolbar, stack);
}
...
/**
 * totem_player_toolbar_set_search_mode:
 * @bar: a #TotemPlayerToolbar
 ...
 **/
void
totem_player_toolbar_set_search_mode (TotemPlayerToolbar *bar,
                                    gboolean          search_mode)
{
  ...
  if (search_mode == FALSE)
    totem_player_toolbar_set_search_string (bar, "");
  g_object_notify (G_OBJECT (bar), "search-mode");
}

gboolean
totem_player_toolbar_get_search_mode (TotemPlayerToolbar *bar)
{
  g_return_val_if_fail (TOTEM_IS_PLAYER_TOOLBAR (bar), FALSE);

  return bar->search_mode;
}

void
totem_player_toolbar_set_select_mode (TotemPlayerToolbar *bar,
                                    gboolean          select_mode)
{
  g_return_if_fail (TOTEM_IS_PLAYER_TOOLBAR (bar));
...
gboolean
totem_player_toolbar_get_select_mode (TotemPlayerToolbar *bar)
{
  g_return_val_if_fail (TOTEM_IS_PLAYER_TOOLBAR (bar), FALSE);
...
void
totem_player_toolbar_set_subtitle (TotemPlayerToolbar *bar,
                                 const char       *subtitle)
{
  g_return_if_fail (TOTEM_IS_PLAYER_TOOLBAR (bar));
...
const char *
totem_player_toolbar_get_subtitle (TotemPlayerToolbar *bar)
{
  g_return_val_if_fail (TOTEM_IS_PLAYER_TOOLBAR (bar), NULL);
...
void
totem_player_toolbar_set_search_string (TotemPlayerToolbar *bar,
...
const char *
totem_player_toolbar_get_search_string (TotemPlayerToolbar *bar)
{
  g_return_val_if_fail (TOTEM_IS_PLAYER_TOOLBAR (bar), NULL);
...
void
totem_player_toolbar_set_n_selected (TotemPlayerToolbar *bar,
                                   guint             n_selected)
{
  g_return_if_fail (TOTEM_IS_PLAYER_TOOLBAR (bar));
...
guint
totem_player_toolbar_get_n_selected (TotemPlayerToolbar *bar)
{
  g_return_val_if_fail (TOTEM_IS_PLAYER_TOOLBAR (bar), 0);

  return bar->n_selected;
}

void
totem_player_toolbar_pack_start (TotemPlayerToolbar *bar,
                               GtkWidget        *child)
{
  g_return_if_fail (TOTEM_IS_PLAYER_TOOLBAR (bar));
...
void
totem_player_toolbar_pack_end (TotemPlayerToolbar *bar,
                           GtkWidget          *child)
{
  g_return_if_fail (TOTEM_IS_PLAYER_TOOLBAR (bar));
...
void
totem_player_toolbar_set_select_menu_model (TotemPlayerToolbar *bar,
                                          GMenuModel       *model)
{
  g_return_if_fail (TOTEM_IS_PLAYER_TOOLBAR (bar));
...
GMenuModel *
totem_player_toolbar_get_select_menu_model (TotemPlayerToolbar *bar)
{
  g_return_val_if_fail (TOTEM_IS_PLAYER_TOOLBAR (bar), NULL);
...
void
totem_player_toolbar_set_custom_title (TotemPlayerToolbar *bar,
                                     GtkWidget        *title_widget)
{
  g_return_if_fail (TOTEM_IS_PLAYER_TOOLBAR (bar));
  if (title_widget)
...
GtkWidget *
totem_player_toolbar_get_custom_title (TotemPlayerToolbar *bar)
{
  g_return_val_if_fail (TOTEM_IS_PLAYER_TOOLBAR (bar), NULL);
